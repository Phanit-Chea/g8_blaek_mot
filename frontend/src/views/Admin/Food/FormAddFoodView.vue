  ...
  <div class="formAddFood">
    <div class="container shadow w-100">
      <div class="col-8 m-auto p-3">
        <div class="card mb-3">
          <img :src="imagePreview || '../../../assets/FoodDetail/food3.jpg'" class="card-img-top" alt="Food Image"
          ...
          <form class="card-body" @submit="createFood">
            ...
            <div class="addFood" id="addForm" style="margin-left: 13px; margin-right: 13px">
              ...
              <div class="buttonAdd">
                <a href="/admin/food">
                  <button type="button" id="btn_cancel" class="btn btn-danger my-3 w-24" title="Cancel">
                    Cancel
                  </button>
                </a>

                <button type="submit" id="btn_create" class="btn btn-success my-3" title="Create Food">
                  Create Food
                </button>
              </div>
            </div>
