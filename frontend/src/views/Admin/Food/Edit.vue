  ...
  <div class="formAddFood">
    <div class="container shadow w-100">
      <div class="col-8 m-auto p-3">
        <div class="card mb-3">
          <img :src="imagePreview || `http://127.0.0.1:8000/${food.image}`" class="card-img-top" alt="Food Image"
            ...
            <div class="addFood" id="addForm" style="margin-left: 13px; margin-right: 13px">
              <div class="food-name row g-5" style="margin-bottom: 3px">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName" v-model="food.name" required
                    aria-label="Food Name" />
                </div>
                <div class="col-md-6">
                  <label for="inputCookingTime" class="form-label fw-bold siemreap">រយះពេលចំអិន</label>
                  <input type="text" class="form-control" id="inputCookingTime" v-model="food.cooking_time" required
              ...
              <div class="food-image row g-5" style="margin-bottom: 5px">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control" type="url" id="videoUrl" v-model="food.video_url" required
                    aria-label="Video URL" />
                </div>
              </div>
              <div class="row g-5 ">
                <div class="w-50 align-items-center">
                  <label for="category" class="form-label mb-0  fw-bold text-center siemreap">ប្រភេទ</label>
                  <select id="category" class="mt-3 py-2 form-control form-select-sm text-center" required
                    v-model="selectedCategory">
                    <option class="siemreap" value="" selected></option>
                    <option class="siemreap" v-for="category in categories" :key="category.id" :value="category.id">
                      {{ category.title }}
                    </option>
                  </select>
                ...
                <div class="howToCook col-md-6 w-50 ">
                  ...
                  <input type="text" class="form-control ms-0 mt-3" id="ingredients" style="margin-left: 10px"
                    v-model="food.ingredients" required aria-label="Ingredients" />
                </div>
              </div>

              <div class="buttonAdd">
                <router-link to="/admin/food" id="btn_cancel" class="btn btn-danger my-3 w-24 siemreap" title="Cancel"
                  @click="resetForm">
                  បោះបង់
                </router-link>
                <button type="submit" id="btn_create" class="btn btn-success my-3 siemreap" title="Create Food">
                  ផ្លាស់ប្ដូរ
                </button>
              </div>
            </div>
