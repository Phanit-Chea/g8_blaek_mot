...
<template>
  <div class="flex items-center justify-center min-h-screen bg-gray-100">
    <el-card class="w-full max-w-md shadow-lg">
      <span class="material-symbols-outlined" @click="cancel">cancel</span>
      <h3>Login</h3>
      <el-form @submit.prevent="onSubmit">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
          <el-button size="large" class="mt-3 w-full" :disabled="isSubmitting" type="success" native-type="submit">Sign
            in →</el-button>
        </div>
...
const cancel = () => {
  // Add any cancel functionality if needed
}
</script>
