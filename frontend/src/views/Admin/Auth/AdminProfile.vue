        ...
        <div class="row flex-nowrap" style="margin-top: 7%;">
            ...
            <div class="flex flex-col bg-white justify-center rounded-lg h-100vh" style="width:86.8%">
                <div class="container d-flex justify-content-center align-items-center"
                    style="height: 100vh; margin-top: 0; ">
                    <div class="registration-form bg-white shadow" style="width: 65%; border-radius: 20px;margin-top: 0px;">
                        <form @submit.prevent="updateProfile" class="d-flex justify-content-between"
                            enctype="multipart/form-data">
                            <div class="card w-50" style="background-color: #1d243c">
                                <div class="card p-4" style="background-color: #1d243c">
                                    <div>
                                        <div class="card-body">
                                            <div class="profile">
                                                <img :src="previewImage || '../assets/default-avatar.png'"
                                                    @click="selectImage" alt="avatar"
                                                    class="rounded-circle img-fluid border border-5  border-white"
                                                    style="width: 130px; height: 130px; margin-left:8%" />
                                            </div>
                                            <div class="d-flex mt-4">
                                                <i class="fs-4 text-light mb-0 align-middle material-icons">person</i>
                                                <p class="text-white ms-2 mb-0 siemreap text-center ">{{ userStore.user.name }}</p>
                                            </div>

                                            <div class="d-flex mt-3">
                                                <i class="fs-4 text-light mb-0 align-middle material-icons">mail</i>
                                                <p class="text-white ms-2 mb-0">{{ userStore.user.email }}</p>
                                            </div>

                                            <div class="d-flex mt-3">
                                                <i class="fs-4 text-light mb-0 align-middle material-icons">phone</i>
                                                <p class="text-white ms-2 mb-0">(+855) {{ userStore.user.phoneNumber }}
                                                </p>
                                            </div>

                                            <div class="d-flex mt-3">
                                                <i class="fs-4 text-light mb-0 align-middle material-icons">male</i>
                                                <p class="text-white ms-2 mb-0 siemreap text-center">{{ userStore.user.gender }}</p>
                                            </div>

                                            <div class="d-flex mt-3">
                                                <i
                                                    class="fs-4 text-light mb-0 align-middle material-icons">location_on</i>
                            ...
                            <div class="p-4 w-100">
                                ...
                                <div class="form-group mt-2">
                                    <input type="tel" class="form-control siemreap" id="phone-number"
                                        v-model="form.phoneNumber" :placeholder="userStore.user.phoneNumber" />
                                </div>
                                <div class="form-group mt-2">
                                ...
                                <div class="px-3 mt-4 d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn text-white ms-2 text-bold siemreap"
