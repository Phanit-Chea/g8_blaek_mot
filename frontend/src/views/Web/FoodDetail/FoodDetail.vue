<template>
    <div class="FoodDetail p-2">
        ...
        <h1 class="text-success mt-3 mb-3">Food Name</h1>
        ...
        <div class="mt-3 mb-3">
            <div class="btn btn rounded border border-success mr-2 " id="bookmard"><span
                    class="material-symbols-outlined">
                    bookmark_added
                </span></div>
            <div class="btn btn rounded border border-success mr-2" id="download"><span
                    class="material-symbols-outlined">
                    download
                </span></div>
            <div class="btn btn rounded border border-success mr-2" id="print"> <span class="material-symbols-outlined">
                    print
                </span></div>
            <div class="btn btn rounded border border-success mr-2" id="share"> <span class="material-symbols-outlined">
                    share
                </span></div>
        </div>
        <!--======================video and image of food ===========================-->
        <div class="jumbotron jumbotron-fluid p-0 m-0 d-flex justify-content-between">
            <div class="col-9">
            ...
            <div class="col-3 ml-2">
                <!-- <div class="row"> -->
                <div class="card mb-2" id="foodImage1"><img src="../../../assets/FoodDetail/image.png" alt=""
                        width="100%" height="195px">
                </div>
                <div class="card" id="foodImage2"><img src="../../../assets/FoodDetail/image.png" alt="" width="100%"
                        height="195px">
                </div>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-evenly text-white mt-3 m-0">
            <div class="d-flex align-items-center justify-content-center rounded" id="timer" style="width: 380px;">
            ...
            <div class="d-flex align-items-center justify-content-center rounded" id="ingredient" style="width: 380px;">
                <span class="material-symbols-outlined mt-1">
                    grocery
                </span>
            ...
            <div class="d-flex align-items-center justify-content-center rounded" id="nutrition"
                style="width: 380px; height: 100px;">
                <p class="m-0 fs-5" data-toggle="collapse" data-target="#nutritions" aria-expanded="false"
                        ...
                        <ol class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <p class="text-dark">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                    Voluptatibus fuga debitis officiis assumenda vel mollitia ut ex facilis! Voluptate
                                    totam quia ex pariatur porro nam error distinctio molestiae assumenda expedita.</p>
                            </li>
                            <li class="list-group-item">
                    ...
                    <div class="mt-3">
                        <div class="col">
                            <button class="btn btn-dark d-flex align-items-center" type="button" data-toggle="collapse"
                                ...
                                Give us your address <span class="material-symbols-outlined ms-2">location_on</span>
                            </button>
                        </div>
                        <div class="collapse mt-3" id="addressForm">
                            <form>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="input your address"
            ...
            <div class="row d-flex" style="margin-top: 98px;">
                <div class="col-3 col-md-3 mb-3">
                    <div class="card position-relative d-flex card1 zoom-card">
                        <div class="border border-3 border-success rounded-circle w-50 position-absolute start-50 translate-middle-x"
                            style="z-index: 1; top: -85px;">
                            <img src="../../../assets/FoodDetail/image.png" alt="" class="img-fluid rounded-circle">
                        </div>
