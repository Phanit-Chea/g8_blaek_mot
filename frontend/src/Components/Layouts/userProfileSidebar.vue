            ...
            <div class="modal-body">
              <form action="">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control my-3 px-3 siemreap" id="name" aria-describedby="name" placeholder="បញ្ចូលឈ្មោះថតឯកសារ">
                </div>
              </form>
            </div>
            <div class="px-3 pb-3 d-flex justify-content-end">
              <button type="button" class="btn btn-danger siemreap" data-bs-dismiss="modal">បោះបង់</button>
              <button type="button" class="btn ms-2 text-bold siemreap" style="background-color:#238400;">បង្កើត</button>
            </div>
          </div>
        </div>
